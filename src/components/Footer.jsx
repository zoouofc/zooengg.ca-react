...
const Footer = () => (
  <div className="footer--body">
      ...
      <div className="footer--link-container">
        ...
        <div className="link-column link-1">
          ...
          <ul>
            ...
            <li>
              <NavLink to="/executives">Executive Council</NavLink>
            </li>
            <li>
        ...
        <div className="link-column link-2">
          <ul>
            <li>
              <NavLink to="/our-events">Our Events</NavLink>
            </li>
            <li>
              <NavLink to="/calendar">Events Calendar</NavLink>
            </li>
            <li>
              <NavLink to="/zoo-sponsors">Our Sponsors</NavLink>
            </li>
            <li>
    ...
    <section className="footer--lower-content">
      ...
      <p>
        Copyright © 2021 Electrical and Software Engineering Students&#39;
        Society
        <b> | Made with ♡ in Calgary</b>
      </p>
    </section>
  </div>
);

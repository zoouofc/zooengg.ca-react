  ...
  <div className="page--body home">
    <div className="carousel-container">
      ...
      >
        <img src={pic1} alt="" />
        <a
          href="https://linktr.ee/ZOO.UCalgary"
          target="_blank"
          rel="noreferrer"
        >
          <img src={pic5} alt="" />
    ...
    <div className="page--description home">
      <p className="home-text">
        ...
        Students&#39; Society, affectionally referred to as ZOO, is an
        initiative run by students, for students. ZOO aims to support their
        undergraduate students, both academically and socially, by providing
        them with a variety of events to enrich their University experience.
        Through the Society, we hope assist students in clearing the gap between
      ...
      <p className="home-text">
        ...
        to <a href="mailto: execs@zooengg.ca">execs@zooengg.ca</a>. We will
        attempt to answer questions to the best of our ability and if necessary,
        direct you to the relevant Department employee.
      </p>
      <hr />
